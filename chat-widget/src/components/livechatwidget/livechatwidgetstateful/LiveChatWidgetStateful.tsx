...
export const LiveChatWidgetStateful = (props: ILiveChatWidgetProps) => {
    ...
    // function getCurrentLiveChatContext() {
    //     return {
    //         chatToken: {},
    //         requestId: "vkuser1@teamsshows.com"
    //     };
    // }
    ...
    // {
    //     try{           
    //         console.info("GetTeamsToken");
    //         microsoftTeams.app.initialize().then(()=>{
    //             microsoftTeams.app.getContext().then((context)=>{
    //                 const userupn = context.user?.userPrincipalName;
    //                 console.info("UPN:"+userupn);
    //                 dispatch({ type: LiveChatWidgetActionType.SET_PRECHAT_RESPONSE_EMAIL, payload: userupn });
    //                 const type = { "Type": Constants.InputSubmit };
    //                 // const EID = "{\"Id\":\"f69c227e-f03a-ec11-8c62-000d3a827199\",\"Name\":\"Email\",\"IsOption\":false,\"Order\":1,\"IsRequired\":true,\"QuestionText\":\"your email please\"}";
    //                 // const UID = "{\"Id\":\"e0e7a846-fb6d-ec11-8943-000d3a817188\",\"Name\":\"fullname\",\"IsOption\":false,\"Order\":2,\"IsRequired\":false,\"QuestionText\":\"fullname\"}";
                    
    //                 const computedValues = {"{\"Id\":\"f69c227e-f03a-ec11-8c62-000d3a827199\",\"Name\":\"Email\",\"IsOption\":false,\"Order\":1,\"IsRequired\":true,\"QuestionText\":\"your email please\"}":userupn};
    //                 const computedValues2 = {"{\"Id\":\"e0e7a846-fb6d-ec11-8943-000d3a817188\",\"Name\":\"fullname\",\"IsOption\":false,\"Order\":2,\"IsRequired\":false,\"QuestionText\":\"fullname\"}:":userupn};
                    
    //                 const finalPayload = {...type, ...computedValues,...computedValues2};
    ...
    useEffect(() => {
        if (state.appStates.skipChatButtonRendering) {
            console.info("skipChatButtonRendering 1");
            
            if (props.reconnectChatPaneProps?.reconnectId && !state.appStates.reconnectId) {
                console.info("reconnect:"+props.reconnectChatPaneProps?.reconnectId);
                ...
                getReconnectIdForAuthenticatedChat(props, chatSDK).then((authReconnectId) => {
                    if (authReconnectId && !state.appStates.reconnectId) {
                        console.info("getReconnectIdForAuthenticatedChat reconnect:"+authReconnectId);
                        ...
                        console.info("skipChatButtonRendering 2");
                        ...
                        try{           
                            ...
                            microsoftTeams.app.initialize().then(()=>{
                                microsoftTeams.app.getContext().then((context)=>{
                                    ...
                                    const finalPayload = {...type, ...computedValues2,...computedValues};
                                    console.info("finalPayload");
                                    console.info(finalPayload);
